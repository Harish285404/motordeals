...
@endif
        ...
        <section class="edit-profile">
              ...
              <form  action="{{ url('admin/edit-user-data/'.$data[0]->id)}}" method="Post" enctype="multipart/form-data" class="account-form-detail" id="adduser">
                 @csrf
                ...
                <div class="user_image-block">
                    <div class="file-upload">
                        <div class="image-upload-wrap">
                            ...
                            <div class="drag-text">
                                <img src="{{asset('User-images/'.$data[0]->image)}}">
                            </div>
                        </div>
                    ...
                    <div class="user_details">
                        ...
                        <div class="col">
                            ...
                            <div class="col">
                                 ...
                                 <div class="col-inner">
                                <input type="tel" id="phone_number" name="phone_number" value="{{$data[0]->phone_number}}" readonly>
