...
<div class="news-main-block" id="news-main-blo-{{ $loop->iteration }}">
    ...
    ?>
                                          ...
                                          <div class="main-icons">
                                             <a href="{{url('user/view-product/'.$sales->id)}}">
                                             ...
                                             <a href="{{url('user/edit-product/'.$sales->id)}}">
                                             ...
                                             <a href="{{url('user/delete-product/'.$sales->id)}}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 33 33" fill="none">
...
success: function(response) {
    ...
    if (response.length > 0) {
        $.each(response, function(index, sales1) {
            ...
            divHTML += '</div>'; 
            divHTML += '<div class="main-icons">';
            divHTML += '<a href="https://f.motordeals.net/user/view-product/'+sales1.id+'"><svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 33 33" fill="none"><rect width="32.5581" height="32.5581" rx="5" fill="white"/><path d="M17 11C11.4104 11 7 16.4996 7 16.4996C7 16.4996 11.4104 22 17 22C21.2741 22 27 16.4996 27 16.4996C27 16.4996 21.2741 11 17 11ZM17 19.926C15.037 19.926 13.4393 18.3889 13.4393 16.4996C13.4393 14.6103 15.037 13.0725 17 13.0725C18.963 13.0725 20.5607 14.6103 20.5607 16.4996C20.5607 18.3889 18.963 19.926 17 19.926ZM17 14.4991C16.7238 14.4941 16.4493 14.5421 16.1926 14.6404C15.9359 14.7387 15.7021 14.8852 15.505 15.0714C15.3078 15.2576 15.1512 15.4798 15.0442 15.725C14.9373 15.9702 14.8822 16.2334 14.8822 16.4993C14.8822 16.7652 14.9373 17.0284 15.0442 17.2736C15.1512 17.5187 15.3078 17.7409 15.505 17.9272C15.7021 18.1134 15.9359 18.2599 16.1926 18.3582C16.4493 18.4564 16.7238 18.5045 17 18.4994C17.5444 18.4896 18.063 18.2745 18.4443 17.9005C18.8256 17.5264 19.0393 17.0233 19.0393 16.4993C19.0393 15.9753 18.8256 15.4721 18.4443 15.0981C18.063 14.7241 17.5444 14.509 17 14.4991Z" fill="#0F8DC2"/></svg></a>';
            divHTML += '<a href="https://f.motordeals.net/user/edit-product/'+sales1.id+'"><svg xmlns="http://www.w3.org/2000/svg" width="34" height="33" viewBox="0 0 34 33" fill="none"><rect x="0.720703" width="32.5581" height="32.5581" rx="5" fill="white"/><path d="M11 21.0837V24H13.9163L22.5173 15.3989L19.6011 12.4827L11 21.0837ZM24.7726 13.1437C24.8447 13.0718 24.9019 12.9863 24.9409 12.8922C24.9799 12.7981 25 12.6973 25 12.5954C25 12.4936 24.9799 12.3927 24.9409 12.2987C24.9019 12.2046 24.8447 12.1191 24.7726 12.0472L22.9528 10.2274C22.8809 10.1553 22.7954 10.0981 22.7013 10.0591C22.6073 10.0201 22.5064 10 22.4046 10C22.3027 10 22.2019 10.0201 22.1078 10.0591C22.0137 10.0981 21.9282 10.1553 21.8563 10.2274L20.4332 11.6506L23.3494 14.5668L24.7726 13.1437Z" fill="#6A810B"/></svg></a>';
            divHTML += '<a href="https://f.motordeals.net/user/delete-product/'+sales1.id+'"><svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 33 33" fill="none"><rect x="0.441406" width="32.5581" height="32.5581" rx="5" fill="white"/><path d="M23 8.83333H20L19.1429 8H14.8571L14 8.83333H11V10.5H23M11.8571 21.3333C11.8571 21.7754 12.0378 22.1993 12.3592 22.5118C12.6807 22.8244 13.1168 23 13.5714 23H20.4286C20.8832 23 21.3193 22.8244 21.6408 22.5118C21.9622 22.1993 22.1429 21.7754 22.1429 21.3333V11.3333H11.8571V21.3333Z" fill="#FF2121"/></svg></a>';
            divHTML += '</div>'; 
            divHTML += '</div>';
            divHTML += '<div class="main-news-icons">';
            divHTML += '<div class="news-content-main">';
  ...
  success: function(response) {
    ...
    if (response.length > 0) {
        $.each(response, function(index, sales2) {
            ...
            divHTML += '</div>'; 
            divHTML += '<div class="main-icons">';
            divHTML += '<a href="https://f.motordeals.net/user/view-product/'+sales2.id+'"><svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 33 33" fill="none"><rect width="32.5581" height="32.5581" rx="5" fill="white"/><path d="M17 11C11.4104 11 7 16.4996 7 16.4996C7 16.4996 11.4104 22 17 22C21.2741 22 27 16.4996 27 16.4996C27 16.4996 21.2741 11 17 11ZM17 19.926C15.037 19.926 13.4393 18.3889 13.4393 16.4996C13.4393 14.6103 15.037 13.0725 17 13.0725C18.963 13.0725 20.5607 14.6103 20.5607 16.4996C20.5607 18.3889 18.963 19.926 17 19.926ZM17 14.4991C16.7238 14.4941 16.4493 14.5421 16.1926 14.6404C15.9359 14.7387 15.7021 14.8852 15.505 15.0714C15.3078 15.2576 15.1512 15.4798 15.0442 15.725C14.9373 15.9702 14.8822 16.2334 14.8822 16.4993C14.8822 16.7652 14.9373 17.0284 15.0442 17.2736C15.1512 17.5187 15.3078 17.7409 15.505 17.9272C15.7021 18.1134 15.9359 18.2599 16.1926 18.3582C16.4493 18.4564 16.7238 18.5045 17 18.4994C17.5444 18.4896 18.063 18.2745 18.4443 17.9005C18.8256 17.5264 19.0393 17.0233 19.0393 16.4993C19.0393 15.9753 18.8256 15.4721 18.4443 15.0981C18.063 14.7241 17.5444 14.509 17 14.4991Z" fill="#0F8DC2"/></svg></a>';
            divHTML += '<a href="https://f.motordeals.net/user/edit-product/'+sales2.id+'"><svg xmlns="http://www.w3.org/2000/svg" width="34" height="33" viewBox="0 0 34 33" fill="none"><rect x="0.720703" width="32.5581" height="32.5581" rx="5" fill="white"/><path d="M11 21.0837V24H13.9163L22.5173 15.3989L19.6011 12.4827L11 21.0837ZM24.7726 13.1437C24.8447 13.0718 24.9019 12.9863 24.9409 12.8922C24.9799 12.7981 25 12.6973 25 12.5954C25 12.4936 24.9799 12.3927 24.9409 12.2987C24.9019 12.2046 24.8447 12.1191 24.7726 12.0472L22.9528 10.2274C22.8809 10.1553 22.7954 10.0981 22.7013 10.0591C22.6073 10.0201 22.5064 10 22.4046 10C22.3027 10 22.2019 10.0201 22.1078 10.0591C22.0137 10.0981 21.9282 10.1553 21.8563 10.2274L20.4332 11.6506L23.3494 14.5668L24.7726 13.1437Z" fill="#6A810B"/></svg></a>';
            divHTML += '<a href="https://f.motordeals.net/user/delete-product/'+sales2.id+'"><svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 33 33" fill="none"><rect x="0.441406" width="32.5581" height="32.5581" rx="5" fill="white"/><path d="M23 8.83333H20L19.1429 8H14.8571L14 8.83333H11V10.5H23M11.8571 21.3333C11.8571 21.7754 12.0378 22.1993 12.3592 22.5118C12.6807 22.8244 13.1168 23 13.5714 23H20.4286C20.8832 23 21.3193 22.8244 21.6408 22.5118C21.9622 22.1993 22.1429 21.7754 22.1429 21.3333V11.3333H11.8571V21.3333Z" fill="#FF2121"/></svg></a>';
            divHTML += '</div>'; 
            divHTML += '</div>';
            divHTML += '<div class="main-news-icons">';
            divHTML += '<div class="news-content-main">';
 ...
 success: function(response) {
    ...
    if (response.length > 0) {
        $.each(response, function(index, sales3) {
            ...
            divHTML += '</div>'; 
            divHTML += '<div class="main-icons">';
            divHTML += '<a href="https://f.motordeals.net/user/view-product/'+sales3.id+'"><svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 33 33" fill="none"><rect width="32.5581" height="32.5581" rx="5" fill="white"/><path d="M17 11C11.4104 11 7 16.4996 7 16.4996C7 16.4996 11.4104 22 17 22C21.2741 22 27 16.4996 27 16.4996C27 16.4996 21.2741 11 17 11ZM17 19.926C15.037 19.926 13.4393 18.3889 13.4393 16.4996C13.4393 14.6103 15.037 13.0725 17 13.0725C18.963 13.0725 20.5607 14.6103 20.5607 16.4996C20.5607 18.3889 18.963 19.926 17 19.926ZM17 14.4991C16.7238 14.4941 16.4493 14.5421 16.1926 14.6404C15.9359 14.7387 15.7021 14.8852 15.505 15.0714C15.3078 15.2576 15.1512 15.4798 15.0442 15.725C14.9373 15.9702 14.8822 16.2334 14.8822 16.4993C14.8822 16.7652 14.9373 17.0284 15.0442 17.2736C15.1512 17.5187 15.3078 17.7409 15.505 17.9272C15.7021 18.1134 15.9359 18.2599 16.1926 18.3582C16.4493 18.4564 16.7238 18.5045 17 18.4994C17.5444 18.4896 18.063 18.2745 18.4443 17.9005C18.8256 17.5264 19.0393 17.0233 19.0393 16.4993C19.0393 15.9753 18.8256 15.4721 18.4443 15.0981C18.063 14.7241 17.5444 14.509 17 14.4991Z" fill="#0F8DC2"/></svg></a>';
            divHTML += '<a href="https://f.motordeals.net/user/edit-product/'+sales3.id+'"><svg xmlns="http://www.w3.org/2000/svg" width="34" height="33" viewBox="0 0 34 33" fill="none"><rect x="0.720703" width="32.5581" height="32.5581" rx="5" fill="white"/><path d="M11 21.0837V24H13.9163L22.5173 15.3989L19.6011 12.4827L11 21.0837ZM24.7726 13.1437C24.8447 13.0718 24.9019 12.9863 24.9409 12.8922C24.9799 12.7981 25 12.6973 25 12.5954C25 12.4936 24.9799 12.3927 24.9409 12.2987C24.9019 12.2046 24.8447 12.1191 24.7726 12.0472L22.9528 10.2274C22.8809 10.1553 22.7954 10.0981 22.7013 10.0591C22.6073 10.0201 22.5064 10 22.4046 10C22.3027 10 22.2019 10.0201 22.1078 10.0591C22.0137 10.0981 21.9282 10.1553 21.8563 10.2274L20.4332 11.6506L23.3494 14.5668L24.7726 13.1437Z" fill="#6A810B"/></svg></a>';
            divHTML += '<a href="https://f.motordeals.net/user/delete-product/'+sales3.id+'"><svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 33 33" fill="none"><rect x="0.441406" width="32.5581" height="32.5581" rx="5" fill="white"/><path d="M23 8.83333H20L19.1429 8H14.8571L14 8.83333H11V10.5H23M11.8571 21.3333C11.8571 21.7754 12.0378 22.1993 12.3592 22.5118C12.6807 22.8244 13.1168 23 13.5714 23H20.4286C20.8832 23 21.3193 22.8244 21.6408 22.5118C21.9622 22.1993 22.1429 21.7754 22.1429 21.3333V11.3333H11.8571V21.3333Z" fill="#FF2121"/></svg></a>';
            divHTML += '</div>'; 
            divHTML += '</div>';
            divHTML += '<div class="main-news-icons">';
            divHTML += '<div class="news-content-main">';
